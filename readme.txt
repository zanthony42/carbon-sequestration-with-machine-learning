...
The dataset used consists of 59 possible bedform architecture instances, each with a set of 40 matrix-laminae pairings. This results in a dataset of 2360 entries.
...
The feature predicted is 'Saturation' which represents the CO2 saturation capacity for a particular bedform instance (one entry of the 2360 row dataset).
